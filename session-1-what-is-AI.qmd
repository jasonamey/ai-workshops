...
## [AI as a Polarizing Conversation Topic]{#slide-2}
...
![Slide 5 - News Media AI and Education](images/session-1/slide-5-news-media-ai-and-education.jpg){width=80%}
...
## ["What is Data?" and the Challenge of Understanding Technology]{#slide-8}
...
![Slide 19 - AI Across Domains](images/session-1/slide-19-ai-domains.jpg)

[&larr; Prev](#slide-18) | [Next &rarr;](#slide-20)

---

## [OpenAI Strategic Framework]{#slide-20}
...
![Slide 20 - Open AI Use Cases](images/session-1/slide-20-open-ai-use-cases.jpg){width=70%} 

[&larr; Prev](#slide-19) | [Next &rarr;](#slide-21)

---

## [Predicting Words and Language]{#slide-21}
...
## [From Prediction Machines to Large Language Models]{#slide-22}

Large Language Models (LLMs) are deep learning models trained on vast amounts of text, designed to predict and generate human-like language. LLMs have become consequential on college campuses because academic life is fundamentally text-based - and when students can generate polished paragraphs instantly, it changes how writing is produced, knowledge is evaluated, and learning is assessed.

![Slide 21 - LLM Logos](images/session-1/slide-22-LLM-logos.jpg)
[&larr; Prev](#slide-21) 
