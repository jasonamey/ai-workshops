...
Public conversations about AI are often shaped by extreme claims from prominent technology leaders and social media discussions. 
...
A crucial component of college education is the mastery of context - examining diverse perspectives and evaluating whether a viewpoint is objectively correct or an expression of the holder's unique background.
...
Higher education has traditionally been understood as a space for emphasizing intellectual development and critical thinking. At the same time, college is increasingly viewed as a pathway to employment. Discussion of AI is making this tension even more pronounced.
...
![Slide 17 - Prediction Dog Cat](images/session-1/slide-17-prediction-dog-cat.jpg){width=55%}
...
![Slide 18 - Prediction Dog Cat Pig Horse](images/session-1/slide-18-prediction-dog-cat-pig-horse.jpg){width=55%}
...
Like Mr. Burns' room of monkeys typing on typewriters in *The Simpsons*, language models do not understand meaning or intention - they produce sequences of symbols. What separates an LLM from random generation is statistical discipline - at every step, the model predicts which word is most likely to come next, keeping output coherent without any underlying understanding.

<!-- ![Slide 20 - LLM Logos](images/session-1/slide-20-LLM-logos.jpg) -->

{{< video https://www.youtube.com/watch?v=loMEF18Ir4s width="560" height="315" >}}
